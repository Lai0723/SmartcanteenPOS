...
public class completedOrder extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        completedOrder = (ListView)v.findViewById(R.id.completedOrder);
    ...
    private class BackgroundWorker extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String retrieveURL = "https://leowwj-wa15.000webhostapp.com/smart%20canteen%20system/getCompletedOrder.php";
    ...
    private void loadListing() {
        ...
        completedOrder.setAdapter(adapter);
